...
def experiment(dataset, dataset_type, mode, ibm_device, ibm_token, varform, layers, seed):
    ...
    # full_model
    full_model_dir = working_dir / "full_model_6"
    ...
    max_features=0.3
    max_samples=0.2
    bag_dir = working_dir / "bagging_feature03_sample02_6"
    ...
    max_features=0.3
    max_samples=1.0
    bag_dir = working_dir / "bagging_feature03_sample10_6"
    os.makedirs(bag_dir,  0o755,  exist_ok=True)
    # if any(pathlib.Path(bag_dir).iterdir()):
    #     print(f"The directory {bag_dir} is not empty, skipping this experiment")
    # else:
    ...
    max_features=0.5
    max_samples=0.2
    bag_dir = working_dir / "bagging_feature05_sample02_6"
    os.makedirs(bag_dir,  0o755,  exist_ok=True)
    # number of qubits bagging
    n_qubits_bag=max(1,int(max_features*X_train.shape[1]))
    # quantum circuit
    ...
    max_features=0.5
    max_samples=1.0
    bag_dir = working_dir / "bagging_feature05_sample10_6"
    os.makedirs(bag_dir,  0o755,  exist_ok=True)
    # if any(pathlib.Path(bag_dir).iterdir()):
    #     print(f"The directory {bag_dir} is not empty, skipping this experiment")
    # else:
    ...
    max_features=0.8
    max_samples=0.2
    bag_dir = working_dir / "bagging_feature08_sample02_6"
    os.makedirs(bag_dir,  0o755,  exist_ok=True)
    # number of qubits bagging
    n_qubits_bag=max(1,int(max_features*X_train.shape[1]))
    # quantum circuit
    ...
    max_features=0.8
    max_samples=1.0
    bag_dir = working_dir / "bagging_feature08_sample10_6"
    os.makedirs(bag_dir,  0o755,  exist_ok=True)
    # if any(pathlib.Path(bag_dir).iterdir()):
    #     print(f"The directory {bag_dir} is not empty, skipping this experiment")
    # else:
    ...
    # adaboost
    n_estimators=6
    ada_dir = working_dir / "adaboost_6"
