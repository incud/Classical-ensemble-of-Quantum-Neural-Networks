...
def plot_first_experiment(directory_experiment, title='Average MSE and std of the models'):
    ...
    x_ticks = ['full_model', 'bagging_feature03_sample02_6', 'bagging_feature03_sample10_6', 'bagging_feature05_sample02_6', 'bagging_feature05_sample10_6', 'bagging_feature08_sample02_6', 'bagging_feature08_sample10_6',  'adaboost_6']
...
def plot_error_layers(directory_experiment, dataset, title=f"Error of each model in terms of the number of layers"):
    ...
    for i, model in enumerate(x_ticks):
        if model == 'full_model':
            ...
            print('\n')
            plt.plot(model_errors_even, marker=markers[count])
            count += 1
