...
def plot_error_layers(directory_experiment, dataset, title=f"Accuracy of Experiment IV"):
    ...
    x_ticks = ['full_model', 'bagging_feature03_sample02_4', 'bagging_feature03_sample10_4', 'bagging_feature05_sample02_4', 'bagging_feature05_sample10_4', 'bagging_feature08_sample02_4', 'bagging_feature08_sample10_4',  'adaboost_4']
    markers = ['o', 'P', '8', 'x', 's', 'p']
    count = 0
